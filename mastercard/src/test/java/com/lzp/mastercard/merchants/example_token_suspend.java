...
//  *
//  * Script-Name: example_token_suspend
//  */
//
...
//
// public class example_token_suspend {
//
...
//       map.set("reason", "Lost/stolen device");
//       map.set("reasonCode", "DEVICE_LOST");
//       map.set("causedBy", "CARDHOLDER");
//       Suspend response = Suspend.create(map);
//
...
//       out(response, "tokens[0].status"); //-->SUSPENDED
//       out(response, "tokens[0].suspendedBy[0]"); //-->ISSUER
//       out(response, "tokens[0].suspendedBy[1]"); //-->CARDHOLDER
//       out(response, "tokens[1].tokenUniqueReference"); //-->DWSPMC00000000032d72d4ffcb2f4136a0532d32d72d4fcb
//       out(response, "tokens[1].status"); //-->SUSPENDED
//       out(response, "tokens[1].suspendedBy[0]"); //-->ISSUER
//       out(response, "tokens[1].suspendedBy[1]"); //-->CARDHOLDER
//       out(response, "tokens[2].tokenUniqueReference"); //-->DWSPMC000000000fcb2f4136b2f4136a0532d2f4136a0532
//       out(response, "tokens[2].status"); //-->SUSPENDED
//       out(response, "tokens[2].suspendedBy[0]"); //-->ISSUER
//       out(response, "tokens[2].suspendedBy[1]"); //-->CARDHOLDER
