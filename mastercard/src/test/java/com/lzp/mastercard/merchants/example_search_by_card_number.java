...
//  *
//  * Script-Name: example_search_by_card_number
//  */
//
...
//
// public class example_search_by_card_number {
//
...
//       map.set("cardInfo.publicKeyFingerprint", "4c4ead5927f0df8117f178eea9308daa58e27c2b");
//       map.set("cardInfo.encryptedKey", "A1B2C3D4E5F6112233445566");
//       map.set("cardInfo.oaepHashingAlgorithm", "SHA512");
//       map.set("tokenRequestorId", "98765432101");
//       SearchTokens response = SearchTokens.create(map);
//
...
//       out(response, "tokens[2].suspendedBy[0]"); //-->TOKEN_REQUESTOR
