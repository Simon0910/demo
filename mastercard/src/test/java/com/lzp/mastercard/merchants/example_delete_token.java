...
//  *
//  * Script-Name: example_delete_token
//  */
//
...
//
// public class example_delete_token {
//
...
//       map.set("reason", "LOST_STOLEN_DEVICE");
//       Delete response = Delete.create(map);
//
