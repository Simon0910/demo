...
//  */
// package com.jdd.thf.tr.channel.master.core;
//
// import com.jdd.thf.tr.channel.master.core.auth.Authentication;
// import com.jdd.thf.tr.channel.master.core.utils.SSLUtil;
// import com.tr.core.*;
...
//
//     private static String defaultClasspathKeyFileName;
//
...
//
//     @Value("${master.ssl.enable:false}")
//     public void setIsEnable(boolean isEnable) {
//         Configuration.isEnable = isEnable;
//         log.debug("ssl.enable = {}", Configuration.isEnable);
//     }
//
//     @Value("${master.ssl.classpathKeyFileName:keystore.jks}")
//     public void setDefaultClasspathKeyFileName(String defaultClasspathKeyFileName) {
//         Configuration.defaultClasspathKeyFileName = defaultClasspathKeyFileName;
//     }
//
//     @Value("${master.ssl.keystore:yourKeyStorePath}")
//     public void setDefaultKeyStorePath(String defaultKeyStorePath) {
//         Configuration.defaultKeyStorePath = defaultKeyStorePath;
//         log.debug("defaultKeyStorePath = {}", defaultKeyStorePath);
//     }
//
//     @Value("${master.ssl.keystore.pass:yourKeyStorePassword}")
...
//     }
//
//     private void loadkeyManagers(InputStream keystore, String KeyStorePassword) throws CertificateException {
//         try {
//             KeyStore keyStore = SSLUtil.getKeyStore(keystore, "jks", KeyStorePassword);
//             keyManagers = SSLUtil.getKeyManagers(keyStore, KeyStorePassword);
//         } catch (Exception e) {
//             e.printStackTrace();
//             throw new CertificateException();
...
// </configuration>
// </plugin>
//                 InputStream keyStore = Configuration.class.getClassLoader().getResourceAsStream(defaultClasspathKeyFileName);
//                 loadkeyManagers(keyStore, defaultKeyStorePassword);
...
//             log.debug("httpClient init sucessful");
