...
public class TokenizeApi {
    ...
    private OperationConfig initOperationConfig() {
        if (operationConfig == null) {
            operationConfig = new OperationConfig("/mdes/digitization/static/1/0/tokenize", Arrays.asList(""), Arrays.asList(""));
            // operationConfig = new OperationConfig("/mdes/digitization/1/0/tokenize", Arrays.asList(""), Arrays.asList(""));
        }
