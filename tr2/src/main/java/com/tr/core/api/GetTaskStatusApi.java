...
public class GetTaskStatusApi {
    ...
    private void initOperationConfig() {
        if (operationConfig == null) {
            operationConfig = new OperationConfig("/mdes/digitization/1/0/getTaskStatus", Arrays.asList(""), Arrays.asList(""));
        }
    }
    /**
     ...
     * </table>
     */
    public okhttp3.Call getTaskStatusCall(GetTaskStatusRequestSchema getTaskStatusRequestSchema,
    ...
    private okhttp3.Call getTaskStatusValidateBeforeCall(GetTaskStatusRequestSchema getTaskStatusRequestSchema,
                                                         final ApiCallback _callback) throws ApiException {
    ...
    public ApiResponse<GetTaskStatusResponseSchema> getTaskStatusWithHttpInfo(GetTaskStatusRequestSchema getTaskStatusRequestSchema) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<GetTaskStatusResponseSchema>() {
        }.getType();
     ...
     * </table>
     */
    public okhttp3.Call getTaskStatusAsync(GetTaskStatusRequestSchema getTaskStatusRequestSchema,
                                           final ApiCallback<GetTaskStatusResponseSchema> _callback) throws ApiException {
