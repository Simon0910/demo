...
public class GetAssetApi {
    ...
    private OperationConfig initOperationConfig() {
        if (operationConfig == null) {
            operationConfig = new OperationConfig("/mdes/assets/1/0/asset/{AssetId}", Arrays.asList(""), Arrays.asList(""));
        }
    ...
    public ApiResponse<AssetResponseSchema> getAssetWithHttpInfo(String assetId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<AssetResponseSchema>() {
        }.getType();
