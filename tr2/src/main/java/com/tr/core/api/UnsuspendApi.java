...
import com.tr.core.*;
import com.tr.core.model.UnSuspendRequestSchema;
import com.tr.core.model.UnSuspendResponseSchema;
...
public class UnsuspendApi {
    ...
    private void initOperationConfig() {
        if (operationConfig == null) {
            operationConfig = new OperationConfig("/mdes/digitization/1/0/unsuspend", Arrays.asList(""), Arrays.asList(""));
        }
    }
