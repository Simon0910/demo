...
import com.lzp.mastercard.mdes.client.model.NotifyTokenUpdatedRequestSchema;
import com.lzp.mastercard.mdes.client.model.NotifyTokenUpdatedResponseSchema;
...
public class NotifyTokenUpdatedApi {
    ...
    public ApiResponse<NotifyTokenUpdatedResponseSchema> notifyTokenUpdateForTokenStateChangeWithHttpInfo(NotifyTokenUpdatedRequestSchema notifyTokenUpdatedRequestSchema) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<NotifyTokenUpdatedResponseSchema>() {
        }.getType();
