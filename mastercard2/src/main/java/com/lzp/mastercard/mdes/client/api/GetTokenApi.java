...
import com.lzp.mastercard.mdes.client.model.GetTokenRequestSchema;
import com.lzp.mastercard.mdes.client.model.GetTokenResponseSchema;
...
public class GetTokenApi {
    ...
    public ApiResponse<GetTokenResponseSchema> getTokenWithHttpInfo(GetTokenRequestSchema getTokenRequestSchema) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<GetTokenResponseSchema>() {
        }.getType();
