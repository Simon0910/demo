...
import com.lzp.mastercard.mdes.client.model.SearchTokensRequestSchema;
import com.lzp.mastercard.mdes.client.model.SearchTokensResponseSchema;
...
public class SearchTokensApi {
    ...
    public ApiResponse<SearchTokensResponseSchema> searchTokensWithHttpInfo(SearchTokensRequestSchema searchTokensRequestSchema) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<SearchTokensResponseSchema>() {
        }.getType();
