...
import com.example.mvc.utils.StringUtil;
...
public abstract class JsonEngine {
    ...
    private static final Pattern LAST_ELEMENT_IN_PATH_PATTERN = Pattern.compile(".*(\\['.*'\\])"); // Returns
    // "['obj2']" for "$['obj1']['obj2']"
    ...
    public boolean isNullOrEmptyJson(Object jsonElement) {
        return jsonElement == null
                || StringUtil.isNullOrEmpty(toJsonString(jsonElement))
