...
import static com.example.mvc.utils.EncodingUtils.encodeBytes;


/**
 * Encryption parameters for computing field level encryption/decryption.
 */
public final class MvcFieldLevelEncryptionParams {
    ...
    private final MvcFieldLevelEncryptionConfig config;
    private Key secretKey;
    private IvParameterSpec ivParameterSpec;

    public MvcFieldLevelEncryptionParams(String ivValue, String encryptedKeyValue, String oaepPaddingDigestAlgorithmValue, MvcFieldLevelEncryptionConfig config) {
     ...
     *
     * @param config A {@link MvcFieldLevelEncryptionConfig} instance
     * @return A {@link MvcFieldLevelEncryptionParams} instance
     * @throws EncryptionException
     */
    public static MvcFieldLevelEncryptionParams generate(MvcFieldLevelEncryptionConfig config) throws EncryptionException {
        ...
        MvcFieldLevelEncryptionParams params = new MvcFieldLevelEncryptionParams(ivSpecValue, encryptedKeyValue,
    ...
    public Key getSecretKey() throws EncryptionException {
        try {
            ...
            secretKey = MvcFieldLevelEncryptionParams.unwrapSecretKey(config, encryptedSecretKeyBytes, oaepPaddingDigestAlgorithmValue);
            return secretKey;
    ...
    protected static byte[] wrapSecretKey(MvcFieldLevelEncryptionConfig config, Key key) throws EncryptionException {
        try {
    ...
    protected static Key unwrapSecretKey(MvcFieldLevelEncryptionConfig config, byte[] keyBytes, String oaepDigestAlgorithm) throws EncryptionException {
