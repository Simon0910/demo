...
public class GetTokenRequestSchema extends BaseRequestSchema {
    ...
    /**
     * Identifier for the specific Mobile Payment App instance, unique across a given Wallet Identifier. This value
     * cannot be changed after digitization. This field is alphanumeric and additionally web-safe base64 characters
     * per RFC 4648 (minus \&quot;-\&quot;, underscore \&quot;_\&quot;) up to a maximum length of 48, &#x3D; should
     * not be URL encoded. Conditional - not applicable for server-based tokens but required otherwise.     __Max
     * Length:48__
     *
    ...
    @ApiModelProperty(example = "123456789", value = "Identifier for the specific Mobile Payment App instance, unique" +
            ...
            " to a maximum length of 48, = should not be URL encoded. Conditional - not applicable for server-based " +
            "tokens but required otherwise.     __Max Length:48__ ")
     ...
     **/
    @ApiModelProperty(example = "DWSPMC000000000132d72d4fcb2f4136a0532d3093ff1a45", required = true, value = "The " +
            "specific Token to be queried.     __Max Length:64__  ")
